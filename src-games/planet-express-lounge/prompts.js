...
export const LENGTH_TARGETS = [
  ["Reply in exactly 1 short punchy sentence.",         65,  5],
  ["Reply in 1-2 sentences.",                           90, 10],
  ["Reply in 2-3 sentences.",                          125,  8],
  ["Reply in 3-4 sentences with a bit of detail.",     175,  3],
];

export const LENGTH_TARGETS_SINGLE = [
  ["Reply in 1-2 sentences.",                             105,  4],
  ["Reply in 2-3 sentences.",                             155,  8],
  ["Reply in 3-4 sentences with personality and detail.", 215,  5],
  ["Reply in 4-5 engaging sentences.",                    275,  2],
];
